import { SettingsClientDTO, SettingsServerDTO, UpdateSettingsClientDTO } from '@arch/contracts'
...
async function update(
  settings: UpdateSettingsClientDTO | null
): Promise<IpcResponse<SettingsServerDTO>> {
  try {
